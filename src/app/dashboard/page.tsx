...
export default function Home() {
  ...
  return (
    <section className="bg-gradient-to-b from-blue-800 to-green-300 text-white min-h-screen flex flex-col items-center justify-center px-6 py-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6 flex flex-col items-center">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Cash Detective</h1>
          <button
